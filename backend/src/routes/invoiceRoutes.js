...
router.get('/', authenticate, authorize('dealer_admin', 'dealer_staff', 'sales_executive', 'territory_manager', 'area_manager', 'regional_manager', 'regional_admin', 'super_admin', 'technical_admin', 'finance_admin'), checkPermission('invoices.view'), applyScoping(['Invoice']), invoiceController.getAllInvoices);
router.get('/:id', authenticate, authorize('dealer_admin', 'dealer_staff', 'sales_executive', 'territory_manager', 'area_manager', 'regional_manager', 'regional_admin', 'super_admin', 'technical_admin', 'finance_admin'), checkPermission('invoices.view'), applyScoping(['Invoice']), invoiceController.getInvoiceById);
router.get('/:id/pdf', authenticate, authorize('dealer_admin', 'dealer_staff', 'sales_executive', 'territory_manager', 'area_manager', 'regional_manager', 'regional_admin', 'super_admin', 'technical_admin', 'finance_admin'), checkPermission('invoices.view'), applyScoping(['Invoice']), invoiceController.generateInvoicePDF);
