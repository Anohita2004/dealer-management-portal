...
router.get('/pending/approvals', authenticate, authorize('dealer_admin', 'territory_manager', 'area_manager', 'regional_manager', 'regional_admin', 'sales_executive'), checkPermission('invoices.view'), invoiceController.getPendingInvoices);
